...
<div class="bannerContainer">
    <span class={bannerCentered ? 'bannerIconHidden' : 'bannerIcon'}>
    ...
    <p class={bannerCentered ? 'bannerTextCentered' : 'bannerText'}>{bannerText}</p>

    <button class={bannerCentered ? 'bannerButtonCentered' : 'bannerButton'}>{buttonText}</button>
